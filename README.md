...
> The second thing you have to do, is to observe which game objects have which layers. And the next thing is to check how the hierarchy, cameras, and rigid-body collision types are set. These are self-explanatory, hopefully, you can understand how everything is set up now.
